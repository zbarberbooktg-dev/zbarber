...
export const translations = {
  fr: {
    ...
    about: {
      ...
      forBarbers: "Pour les barbiers",
      forBarbersDesc:
        "Gérez votre agenda, créez un portfolio digital et acceptez les réservations gratuitement. Le financement pour développer votre activité sera disponible prochainement.",
    ...
    features: {
      ...
      subtitle:
        "Des outils puissants conçus pour le workflow unique des salons de barbiers africains.",
      items: [
    ...
    pricing: {
      ...
      premiumTitle: "Global Premium — À venir",
      premiumDesc: "Cette offre sera disponible prochainement. Profitez gratuitement de Zbarber dès maintenant.",
      premiumPrice: "À venir",
      comingSoon: "À venir",
      premiumFeatures: [
        "À venir : profil premium avec bannière vidéo",
        "À venir : classement prioritaire dans les recherches locales",
        "À venir : photos de portfolio illimitées",
        "À venir : 0 % de commission sur les réservations",
        "À venir : statistiques business avancées",
        "À venir : accès au programme de financement matériel",
        "À venir : marketing automatisé vers vos anciens clients",
      ],
      premiumCta: "Fonctionnalités Premium — À venir",
    },
    ctaBarbers: {
      ...
      benefits: "Avantages Premium — À venir",
    },
    faq: {
      ...
      items: [
        ...
        { q: "Qu'est-ce que le programme de financement matériel ? (À venir)", a: "Ce programme sera disponible prochainement. Pour le moment, toutes les fonctionnalités Zbarber disponibles sont gratuites." },
  ...
  en: {
    ...
    about: {
      ...
      forBarbers: "For Barbers",
      forBarbersDesc:
        "Manage your schedule, build a digital portfolio, and accept bookings for free. Financing to grow your business will be available soon.",
    ...
    features: {
      ...
      subtitle:
        "Powerful tools designed specifically for the unique workflow of African barbershops.",
      items: [
    ...
    pricing: {
      ...
      premiumTitle: "Global Premium — Coming soon",
      premiumDesc: "This offer will be available soon. Enjoy Zbarber for free in the meantime.",
      premiumPrice: "Coming soon",
      comingSoon: "Coming soon",
      premiumFeatures: [
        "Coming soon: premium profile with video banner",
        "Coming soon: priority ranking in local searches",
        "Coming soon: unlimited portfolio photos",
        "Coming soon: 0% commission on bookings",
        "Coming soon: advanced business analytics",
        "Coming soon: access to equipment financing program",
        "Coming soon: automated marketing to past clients",
      ],
      premiumCta: "Premium features — Coming soon",
    },
    ctaBarbers: {
      ...
      benefits: "Premium benefits — Coming soon",
    },
    faq: {
      ...
      items: [
        ...
        { q: "What is the equipment financing program? (Coming soon)", a: "This program will be available soon. For now, all available Zbarber features are free." },
